export { FaSlackHash,FaUser,FaFacebookSquare, FaCoins, FaUserEdit, FaTimes,FaMapMarkerAlt} from 'react-icons/fa'
export { TbDiscount2 } from 'react-icons/tb'
export { BsFillPinMapFill,BsPencilSquare,BsFillStarFill,BsBookmarkStarFill,BsCheckAll,BsThreeDots,BsFacebook, BsFillPauseFill, BsPlayFill, BsTrash, BsStarHalf} from 'react-icons/bs'
